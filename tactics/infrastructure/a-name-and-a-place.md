...
{% hint style="info" %}
Fun fact: In the [2020 Design Systems Survey conducted by Sparkbox](https://designsystemssurvey.seesparkbox.com/2020/), almost a third of all participants stated that their design system doesn't have a name.
{% endhint %}
